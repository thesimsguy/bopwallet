...
import { WalletAppComponent } from "./components/WalletAppComponent";

export const WalletApp: BaseApp = {
  id: "wallet",
  name: "Wallet",
  icon: {
    type: "image",
...
export const appMetadata = WalletApp.metadata;
export const helpItems = WalletApp.helpItems;
